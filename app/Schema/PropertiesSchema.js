...
export const PropertiesSchemas = [
  z.object({
    ...
    bedrooms: z.number().min(1, "Bedrooms required").optional(),
    bathrooms: z.number().min(1, "Bathrooms required").optional(),
    area_sqft: z.number().min(1, "Area is required").optional(),
    years_build: z.number().min(1, "Year built is required").optional(),
    land_area: z.number().min(1, "Land area is required").optional(),
    garages: z.number().min(1, "Garages is required").optional(),
    garage_size: z.number().min(1, "Garage size is required").optional(),
  }),
